...
const Card2 = () => {
  ...
  return (
    <div className="min-w-[280px] flex max-md:flex-col w-[730px] bg-white rounded-lg shadow-md h-[288px] max-md:max-w-96">
      <div>
        <img
          src={imgdrawers}
      ...
      <div className="bg-white p-8 max-md:pb-4 flex-1 rounded-r-lg max-md:rounded-b-lg">
        <h1 className="font-[700] text-xl">
          Shift the overall look and feel by adding these wonderful touches to
          furniture in your home
        </h1>
        <p className="py-4 max-md:pb-5">
